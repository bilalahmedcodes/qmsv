...
//        if (in_array(Auth::user()->roles[0]->name, ['Team Lead', 'Manager']) && (!in_array(Auth::user()->hrms_id, ['87223','238430','386433']))) {
//            $query = $query->where('campaign_id', Auth::user()->campaign_id);
//        }

        if (in_array(Auth::user()->roles[0]->name, ['Team Lead', 'Manager', 'Director']) && (in_array(Auth::user()->hrms_id, ['87223','238430','386433']))) {
